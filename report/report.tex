...
\author[1,2]{Joan Salvà Soler*\orcidA{}} 
\author[1]{Grégoire de Lambertye\orcidB{}}

\affil[1]{Technische Universität Wien}
\affil[2]{H2O.ai}
...
Due to its robust performance and adaptability, \gls{grasp} has been successfully applied to the classical \gls{tsp}, often achieving results that are competitive with highly specialized heuristics~\cite{Oliveira2004}. 
...
As construction heuristics, we consider the Simple Randomized Construction, the Randomized Greedy Construction, and the \gls{mip}-based Random Perturbation.
...
\subsection{Construction Heuristics} \label{sec:constr_heuristic}
