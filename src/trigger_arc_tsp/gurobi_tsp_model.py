...
if GUROBI_AVAILABLE:
    ...
    class GurobiTSPModel:
        def __init__(self, instance: "Instance") -> None:
            raise RuntimeError("Gurobi is not installed. GurobiTSPModel is unavailable.")

        def formulate(self) -> None:
            raise RuntimeError("Gurobi is not installed. Cannot formulate model.")

        def solve_to_feasible_solution(self) -> None:
            raise RuntimeError("Gurobi is not installed. Cannot solve model.")
        ...
        def get_best_tour(self) -> list[int]:
            raise RuntimeError("Gurobi is not installed. No solutions available.")
