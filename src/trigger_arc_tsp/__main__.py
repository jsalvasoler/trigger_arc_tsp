...
def evaluate_command(
    instance: str | None, time_limit_sec: int = 60, he: float = 0.05, *, mip_start: bool = False
) -> None:
    click.echo(f"Running Gurobi MIP model for instance: {instance}")
    gurobi_main(instance, time_limit_sec=time_limit_sec, heuristic_effort=he, mip_start=mip_start)
